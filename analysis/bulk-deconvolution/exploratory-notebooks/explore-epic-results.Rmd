...
Notably, `TRef` includes fibroblasts and endothelial cells, which we are interested in being able to quantify!
...
Let's look at the samples had very few "other" cells (those with fraction < 0.1):
