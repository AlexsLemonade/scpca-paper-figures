...
* We can use the `celltype_validation_groups` data frame to identify immune cell types to use in comparisons
...
ggplot(celltype_category_df) + 
  ...
  scale_fill_manual(values = c("gray85", "chartreuse", "dodgerblue")) + 
...
We'll next visualize the same results, but pooling all projects together. 
