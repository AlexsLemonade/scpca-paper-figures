...
residuals_df <- all_models |>
  ...
  purrr::list_rbind(names_to = "project_id") |>
  dplyr::mutate(
    model_name = forcats::fct_relevel("fit_plain", "fit_additive", "fit_interaction")
  )
```
...
* The lower `\sigma` for interaction models is evident in these residual plots
* Points are generally evenly spread throughout, except for the expected high concentration of points at `(0,0)`

## Export


We'll export the chosen models for each project in this section (forthcoming after a lil review).
