...
```{r, fig.height = 4, fig.width = 12}
make_histogram(unfiltered_df, pseudobulk, "pseudobulk expression distributions across annotation status")
```

```{r, fig.height = 4, fig.width = 12}
make_histogram(unfiltered_df, bulk, "bulk expression distributions across annotation status")
```
