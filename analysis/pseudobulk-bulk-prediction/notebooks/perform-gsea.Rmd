...
So, an `(X,Y)` coordinate can be interpreted as: `Y*100`\% of the shuffled GSEAs found that `X*100`\% of the gene sets were enriched in the given direction.
