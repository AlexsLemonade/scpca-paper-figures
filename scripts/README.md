...
6. `prepare-sample-whitelist.R`: This script is used to prepare the file `../sample-info/sample-whitelist.txt`, which contains a list of samples to include in figures and tables.
